...
def test_build_tree1():
    ...
    records = parse_data(r"C:\Users\user\PycharmProjects\lab1\ex11\tiny_data2.txt")
...
def test_build_tree2():
    ...
    records = parse_data(r"C:\Users\user\PycharmProjects\lab1\ex11\small_data1.txt")
...
def test_build_tree3():
    ...
    records = parse_data(r"C:\Users\user\PycharmProjects\lab1\ex11\medium_data1.txt")
...
def test_build_tree4():
    ...
    records = parse_data(r"C:\Users\user\PycharmProjects\lab1\ex11\medium_data2.txt")
...
def test_optimal_tree1():
    records = parse_data(r"C:\Users\user\PycharmProjects\lab1\ex11\test_optimal_tree1.txt")
...
def test_optimal_tree2():
    records = parse_data(r"C:\Users\user\PycharmProjects\lab1\ex11\test_optimal_tree2.txt")
    tree = optimal_tree(records,["cough", "fever", "headache"],1)

    assert "fever" == tree.data or "headache" == tree.data

def test_optimal_tree3():
    records = parse_data(r"C:\Users\user\PycharmProjects\lab1\ex11\test_optimal_tree3.txt")
